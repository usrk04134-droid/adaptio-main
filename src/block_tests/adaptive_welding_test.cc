...
TEST_SUITE("AdaptiveWeldingTest") {
  TEST_CASE("adaptive_welding_wide_joint_test") {
    ...
    // Test parameters
    //
    // Purpose: Verify adaptive welding logic on a wide joint
    /// Joint Geometry: help_sim::TEST_JOINT_GEOMETRY_WIDE
    help_sim::TestParameters test_parameters{
        ...
        .testcase_parameters{.configuration_file{"src/block_tests/configs/wide_joint_configuration.yaml"},
                        .expected_beads_in_layer{{1, 3}, {2, 4}, {3, 5}}}  // Number of test layers
    };
  ...
  TEST_CASE("adaptive_welding_misaligned_joint_test") {
    ...
    // Test parameters
    //
    // Purpose: Verify adaptive welding logic on a misaligned joint
    /// Joint Geometry: help_sim::TEST_JOINT_GEOMETRY_WIDE
    help_sim::TestParameters test_parameters{
        .abp_parameters{.wall_offset_mm = 2.,
                        .bead_overlap   = 20.,
        ...
        .testcase_parameters{.configuration_file{"src/block_tests/configs/misaligned_joint_configuration.yaml"},
                        .expected_beads_in_layer{{1, 3}, {2, 4}, {3, 4}}}  // Number of test layers
    };
  ...
  TEST_CASE("adaptive_welding_deep_joint") {
    ...
    // Test parameters
    //
    // Purpose: Verify adaptive welding logic on a deep joint
    /// Joint Geometry: help_sim::TEST_JOINT_GEOMETRY_DEEP
    help_sim::TestParameters test_parameters{
        ...
        .testcase_parameters{.configuration_file{"src/block_tests/configs/deep_joint_configuration.yaml"},
                        .expected_beads_in_layer{
                                 {1, 2},
                                 {2, 2},
                                 {3, 2},
                                 {4, 2},
